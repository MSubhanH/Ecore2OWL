...
public class ReadRdfFile {
	...
	public static void main(String[] args) {
		...
		Resource rdfxml = resourceSet.getResource(URI.createURI("examples/com.emf4sw.rdf.examples/src/foaf.rdf"), true);
		...
		Resource ttl = resourceSet.createResource(URI.createURI("examples/com.emf4sw.rdf.examples/src/foaf.ttl"));
