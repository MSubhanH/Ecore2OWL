...
public class FamilyPackageImpl extends EPackageImpl implements FamilyPackage {
	 ...
	 * @generated
	 */
	public EReference getPerson_HasFather() {
	 ...
	 * @generated
	 */
	public EReference getPerson_HasBrother() {
	 ...
	 * @generated
	 */
	public EReference getPerson_HasUncle() {
	...
	public void createPackageContents() {
		...
		createEReference(personEClass, PERSON__HAS_FATHER);
		createEReference(personEClass, PERSON__HAS_BROTHER);
		createEReference(personEClass, PERSON__HAS_UNCLE);
	...
	public void initializePackageContents() {
		...
		initEReference(getPerson_HasFather(), this.getPerson(), null, "hasFather", null, 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPerson_HasBrother(), this.getPerson(), null, "hasBrother", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPerson_HasUncle(), this.getPerson(), null, "hasUncle", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(familyEClass, Family.class, "Family", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFamily_Member(), this.getPerson(), null, "member", null, 1, -1, Family.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
