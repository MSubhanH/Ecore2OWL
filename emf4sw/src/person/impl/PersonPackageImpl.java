...
public class PersonPackageImpl extends EPackageImpl implements PersonPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPerson_Weight(), ecorePackage.getEInt(), "Weight", null, 0, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPerson_Height(), ecorePackage.getEFloat(), "Height", null, 0, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		// DatatypeProperty
		createDatatypePropertyAnnotations();
	}
	...
	protected void createOWLClassAnnotations() {
		...
		addAnnotation
		  (personEClass, 
		   source, 
		   new String[] {
			 "uri", "http://eclipselabs.org/emf4sw/person#Person"
		   });
	}

	/**
	 * Initializes the annotations for <b>DatatypeProperty</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createDatatypePropertyAnnotations() {
		String source = "DatatypeProperty";	
		addAnnotation
		  (getPerson_Name(), 
		   source, 
		   new String[] {
			 "uri", "http://eclipselabs.org/emf4sw/person#name"
		   });
	}
